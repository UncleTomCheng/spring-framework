...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	 ...
	 * to the internal(内部的) BeanFactory.
	 */
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			//（ApplicationContext是对BeanFactory功能上的扩展）
	...
	protected void prepareRefresh() {
		...
		//若multicaster是被允许的，那么允许earlyApplicationEvents集合能够被发布
	...
	/**
	 * Instantiate(实例化) and invoke all registered BeanFactoryPostProcessor beans,
	 ...
	 * respecting(关于、就...而言) explicit(明确的) order if given.
